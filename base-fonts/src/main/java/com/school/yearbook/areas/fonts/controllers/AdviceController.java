package com.school.yearbook.areas.fonts.controllers;
...
public class AdviceController {
    ...
    public String index() {
        return "/areas/fonts/views/advice/index";
    }
    ...
    public String create() {
        return "/areas/fonts/views/advice/create";
    }
    ...
    public String edit(@PathVariable("id") int id) {
        return "/areas/fonts/views/advice/edit";
    }
